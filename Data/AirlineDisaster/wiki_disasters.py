...
r=requests.get("https://zh.wikipedia.org/wiki/Template:2004%E5%B9%B4%E8%88%AA%E7%A9%BA%E4%BA%8B%E6%95%85")
...
for url in urls:
    ...
    if(year):
        ...
        next_urls=re.findall('a href="(/wiki/.*?)" title="',str(block),re.S)
        for next_url in next_urls:
            ...
            if(body):
                with open('my_python/'+year.group()+'/'+file_name.string+'.txt','w',encoding='utf-8') as file:
