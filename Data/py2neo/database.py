...
def database1():
    ...
    csvFile = open("airline_data.csv", "r")
    ...
    for item in reader:
        ...
        if item[0] != "Airline":
            node_airline = Node(
                "Airline", name=item[0], ICAO=item[1], IATA=item[2], Callsign=item[3]
            )
            if item[5] != "":
            ...
            if tar:
                ...
                airline_locates_in = Relationship(node_airline, "locate", node_country)
                my_graph.create(airline_locates_in)
